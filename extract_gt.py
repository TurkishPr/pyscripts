...
#             # modified =1
#             for name in obj.findall('name'):
#                 if obj_name == 'pedestrian' and name.text =='pedestrian':
...
#                     xmax = int(float(obj[1][2].text))
#                     ymax = int(float(obj[1][3].text))
#                     cv2.rectangle(image,(xmin,ymin),(xmax,ymax),(102,255,51),2)
#                     # xmin = int(float(obj[1][4].text))
#                     # ymin = int(float(obj[1][5].text))
#                     # xmax = int(float(obj[1][6].text))
#                     # ymax = int(float(obj[1][7].text))
#                     # cv2.rectangle(image,(xmin,ymin),(xmax,ymax),(0,0,255),2)
#                     # if len(obj[1])>8:
#                     #     hxmin = int(float(obj[1][8].text))
#                     #     hymin = int(float(obj[1][9].text))
#                     #     hxmax = int(float(obj[1][10].text))
#                     #     hymax = int(float(obj[1][11].text))
#                     #     cv2.rectangle(image,(hxmin,hymin),(hxmax,hymax),(255,0,127),2)
#                 elif obj_name == 'ped_ignored' and name.text =='ped_ignored':
#                     modified =1
#                     # xmin = int(float(obj[1][0].text))
#                     # ymin = int(float(obj[1][1].text))
#                     # xmax = int(float(obj[1][2].text))
...
#                 elif obj_name == 'ignored' and name.text == 'ignored':
#                     xmin = int(float(obj[1][0].text))
#                     ymin = int(float(obj[1][1].text))
#                     xmax = int(float(obj[1][2].text))
#                     ymax = int(float(obj[1][3].text))
